package cn.flysdk.pay.module.order.channel.ysdk;
...
{
	/**构造签名的url前缀*/
	private static final String prefix = "/v3/r";
    /**
     * 构造函数
     *
     * @param appid 应用的ID
     ...
     * @return 返回服务器响应内容
     */
    public String api(String scriptName, String method,HashMap<String, String> params, HashMap<String, String> cookie, String protocol) throws OpensnsException
    {
        // 检查openid openkey等参数
        ...
        // 计算签名
        String sig = SnsSigCheck.makeSig(method, prefix+scriptName, params, secret).trim();
        ...
        tmp.putAll(params);
        sb.append("?");
        //将参数转化为url参数形式，可自行编写相关方法
        sb.append(ChannelCommonService.assembleSignData(tmp,"&",null,false));
        String url = sb.toString();

        // cookie
        HashMap<String, String> cookies = cookie;
